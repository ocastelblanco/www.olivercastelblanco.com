export const environment = {
  ...
  // URL absoluta para el fetch durante el prerender (build-time): `fetch()` de
  // Node no acepta URLs relativas como `labContentUrl`, a diferencia del
  // navegador. Apunta al contenido real ya publicado — el build hace una
  // petición de red genuina a producción (ADR-011).
  labContentSsrUrl: 'https://ocastelblanco.com/content/lab.json',
