...
| Campo | Valor |
|---|---|
| Versión | Pre-MVP (sin código de aplicación todavía) |
...
- [ ] Boilerplate Angular 22 (standalone, signals, zoneless, SSR)
...
_Ninguna todavía — `package.json` no existe en `rediseno-2026`. Se actualizará esta tabla al
generar el boilerplate Angular 22._
...
_Ninguno todavía — se documentarán aquí con ejemplos reales una vez exista el boilerplate
Angular 22 (standalone components, signals, estructura de `features/`, etc.)._
...
**Próxima tarea sugerida:** generar `TODO.md` con el motor JIT (2 tareas atómicas) y, según
ese resultado, iniciar el boilerplate de Angular 22 con la skill `angular-new-app`.
