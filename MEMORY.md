...
| Última sesión | 2026-09-22 — PRs #48-#51 fusionados y desplegados. `/content/*` sin 404 limpio evaluado y descartado (requiere Lambda@Edge, impacto bajo). Motor JIT recalculado: SES ya tiene production access (corrige bloqueo documentado) — auto-respuesta al visitante reingresa como Tarea 1; Search Console como Tarea 2 |
